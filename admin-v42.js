/**
 * Joe Builds - Admin Controller (v42 - Standard Auth Header Fetch)
 */
console.log("JB Admin Controller v42 initializing...");
const JoeBuildsAdmin = (() => {
  ...
  const generateStatusOptions = (currentStatus) => { 
      ...
      if (s === 'measured' || s === 'closed') standardizedVal = 'stable';
